...
import PreviewDescontoClient from "./PreviewDescontoClient";
...
export default async function PreviewDescontoPage({ params }: Props) {
  ...
  return <PreviewDescontoClient imageUrl={imageUrl} nome={nome} stickerId={stickerId} />;
}
